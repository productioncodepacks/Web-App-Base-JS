 ...
 * Create new using this as a blueprint or delete starting at ../../httpapi2/
 * according to your application's requirements, then import and set server to
 * use in server.js
 */


/* httpapi2 works with database2 */
import {
  getButtons,
  incrementButton,
  resetAll,
  resetButton
} from "../../../databases/database2/methods"
